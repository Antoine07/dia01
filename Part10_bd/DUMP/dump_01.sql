...
CREATE TABLE `compagnies` (
  ...
  `numStreet` smallint(5) unsigned DEFAULT NULL,
  PRIMARY KEY (`comp`)
...
INSERT INTO `compagnies` VALUES ('AUS','Shenton Park','Perth','australia',20),('CHI','Qinghai','Xian de Tongde','china',17),('FRE1','Rue de la Lieure','Voiron','france',11),('ITA','mapoli','Rome','ITALIA Air',20),('SIN','Marymount','Singapour','singa',1);
