...
# Avec zip on peut également transposer une matrice mais on changera les lignes en tuple, donc ce n'est pas la solution, même si elle est intéressante à considérer.
"""
